    ...
    <Tool>
      ...
      <ToolSection lg={4}>
        <ToolBody color="info" header="Tutorial">
          <h5>Scatter Desktop (Not the Chrome Extension) or Sqrl is required.</h5>
          <p>Load the Transaction JSON you were provided.</p>
          <p>Ensure Scatter or Sqrl is connected with the correct account to sign this transaction.</p>
          <p>Click Sign Transaction</p>
          <p>
            Scatter respectively Sqrl will appear asking you to sign an arbitrary Buffer. This will appear like random
            numbers. This is acceptable, and matches the JSON you loaded.
          </p>
          <p>
