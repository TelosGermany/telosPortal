...
const PoormanInfo = () => {
  return (
    <div>
      ...
      <p>
        The new purpose for POOR is to reward people for STAKING and VOTING for 25+ MAINNET Block Producers. Each month
        we will drop additional POOR to everyone who meets the following criteria:
      </p>
