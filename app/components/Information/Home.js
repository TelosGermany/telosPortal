...
const Home = () => {
  return (
    <div>
      ...
      <h4>Make sure you have read and understand the <a href="https://medium.com/@teloslogical/telos-governance-overview-28a34dbb24e7" target="new">Telos Governance</a> prior to using the Telos Network.</h4>
    </div>
  );
};
